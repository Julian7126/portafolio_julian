...
<div className="w-full h-9 md:h-16 flex-shrink-0 flex items-center p-8">
  ...
  {/* Navegación para web */}
  <div
   className="hidden md:flex-grow md:h-60 md:flex md:items-center md:space-x-10 md:justify-end mt-20 ">
    ...
    <a href="/aboutme" className="text-black font-dm-sans font-semibold text-6xm ml-4">
      ABOUT ME
    </a>
